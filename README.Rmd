...
Look for a company that offers die-cut stickers, such as [StickerApp](https://stickerapp.com/). We recommend using the PNG version of the sticker. The printed stickers should be 1.74" x 2" without rounded corners. We mostly print on vinyl with a matte finish.
