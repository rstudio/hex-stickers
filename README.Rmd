...
<https://swag.posit.co/>. Or [see our instructions](#printing)
...
svg_link <- ifelse(
  file.exists(svg),
  glue::glue('<br /><a href="{svg}">{logos}.svg</a>'),
  ""
)
cell <- paste0("<td>", img, "<br />", png_link, svg_link, "</td>")
...
Look for a company that offers die-cut stickers, such as [StickerApp](https://stickerapp.com/). We recommend using the PNG version of the sticker. The printed stickers should be 1.73" x 2" without rounded corners. We mostly print on vinyl with a matte finish.
